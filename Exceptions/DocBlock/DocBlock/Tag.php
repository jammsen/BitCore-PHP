...
class Tag implements \Reflector
{
    ...
    private static $tagHandlerMappings = array(
        'author'
            => 'DocBlock\Tag\AuthorTag',
        'covers'
            => 'DocBlock\Tag\CoversTag',
        'deprecated'
            => 'DocBlock\Tag\DeprecatedTag',
        'example'
            => 'DocBlock\Tag\ExampleTag',
        'link'
            => 'DocBlock\Tag\LinkTag',
        'method'
            => 'DocBlock\Tag\MethodTag',
        'param'
            => 'DocBlock\Tag\ParamTag',
        'property-read'
            => 'DocBlock\Tag\PropertyReadTag',
        'property'
            => 'DocBlock\Tag\PropertyTag',
        'property-write'
            => 'DocBlock\Tag\PropertyWriteTag',
        'return'
            => 'DocBlock\Tag\ReturnTag',
        'see'
            => 'DocBlock\Tag\SeeTag',
        'since'
            => 'DocBlock\Tag\SinceTag',
        'source'
            => 'DocBlock\Tag\SourceTag',
        'throw'
            => 'DocBlock\Tag\ThrowsTag',
        'throws'
            => 'DocBlock\Tag\ThrowsTag',
        'uses'
            => 'DocBlock\Tag\UsesTag',
        'var'
            => 'DocBlock\Tag\VarTag',
        'version'
            => 'DocBlock\Tag\VersionTag'
    );
